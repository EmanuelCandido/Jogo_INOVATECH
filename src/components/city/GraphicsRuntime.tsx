...
import {useLoadingActive} from '../../game/useLoadingActive';
import {graphicsPixelRatio} from '../../config/graphics';
...
export function GraphicsRuntime({ready}:{ready:boolean}){
 ...
 const settings=useGame(s=>s.progress.settings),probe=useGraphicsRuntime(s=>s.probe),loading=useLoadingActive();
