...
export const assetRegistry: Record<string, ModelAsset> = {
  ...
  'building.house.cottage': {kind:'glb',url:'/assets/models/solar-cottage.glb'},
  'building.solarSchool': {kind:'glb',url:'/assets/models/solar-school.glb'},
  'building.fishMarket': {kind:'glb',url:'/assets/models/fish-market.glb'},
  'building.observatory': {kind:'glb',url:'/assets/models/eco-observatory.glb'},
  'building.ecodome': {kind:'glb',url:'/assets/models/eco-dome.glb'},
  'building.centralStation': {kind:'glb',url:'/assets/models/central-station.glb'},
  'building.recycling': {kind:'glb',url:'/assets/models/recycling-centre.glb'},
  'building.ruined': {kind:'glb',url:'/assets/models/ruined-building.glb'},
  'building.industrial': {kind:'glb',url:'/assets/models/industrial-works.glb'},
  'prop.stationCanopy': {kind:'glb',url:'/assets/models/station-canopy.glb'},
  'prop.platformCanopy': {kind:'glb',url:'/assets/models/station-platform-canopy.glb'},
  'prop.stationGuardrail': {kind:'glb',url:'/assets/models/station-guardrail.glb'},
  'prop.stationStairs': {kind:'glb',url:'/assets/models/station-stairs.glb'},
  'prop.dam': {kind:'glb',url:'/assets/models/river-dam.glb'},
  'prop.archedBridge': {kind:'glb',url:'/assets/models/arched-bridge.glb'},
  'prop.excavator': {kind:'glb',url:'/assets/models/excavator.glb'},
  'prop.pylon': {kind:'glb',url:'/assets/models/grid-pylon.glb'},
  'building.house.terrace': {kind:'glb',url:'/assets/models/house-terrace.glb'},
  'building.house.solar': {kind:'glb',url:'/assets/models/house-solar.glb'},
  'tree.blossom': {kind:'glb',url:'/assets/models/tree-blossom.glb'},
  'tree.palm': {kind:'glb',url:'/assets/models/tree-palm.glb'},
  'tree.rooftop': {kind:'glb',url:'/assets/models/tree-rooftop.glb'},
  'prop.charger': {kind:'glb',url:'/assets/models/ev-charger.glb'},
  'prop.solarCanopy': {kind:'glb',url:'/assets/models/solar-canopy.glb'},
  'prop.trainCab': {kind:'glb',url:'/assets/models/train-cab.glb'},
  'building.station': {kind:'glb',url:'/assets/models/solar-station.glb'},
  'prop.airTreatment': {kind:'glb',url:'/assets/models/air-treatment.glb'},
  ...
  "prop.industrialGate": {kind:"glb",url:"/assets/models/industrial-gate.glb"},
  "prop.roadDeck": {kind:"glb",url:"/assets/models/road-deck-module.glb"},
  "prop.roadPier": {kind:"glb",url:"/assets/models/road-pier-shaft.glb"},
  "prop.roadFooting": {kind:"glb",url:"/assets/models/road-pier-footing.glb"},
  "prop.roadCap": {kind:"glb",url:"/assets/models/road-pier-cap.glb"},
  "prop.roadRetaining": {kind:"glb",url:"/assets/models/road-retaining-wall.glb"},
  ...
  "waste.industrial": {kind:"glb",url:"/assets/models/industrial-waste.glb"},
